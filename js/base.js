$(document).ready(function() {
	...
	metaEl.setAttribute('content', 'width=' + dpr * docEl.clientWidth + ',initial-scale = ' + scale + ', maximum-scale = ' + scale + ',minimum-scale = ' + scale + ', user-scalable = 0');
...
function meibao_alert(message) {
	...
	oDiv.id = "alert";
	var html = "<div class=\"mask\"></div><div class=\"pop-up\"><div class=\"message\"><div>" + message + "</div></div><div class=\"confirm\" onclick=\"hide()\">知道了</div></div>";
	oDiv.innerHTML = html;
